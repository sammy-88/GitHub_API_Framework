Feature: Pull request delete
  As registered user
  I want check creation pull request with custom data and delete it
  So I create specific requests to GitHub  API

  Scenario Outline: Create pull request with custom data and delete it
    ...
    Then I should see text message "<branch_name>" with default branch "master"
    Examples:
